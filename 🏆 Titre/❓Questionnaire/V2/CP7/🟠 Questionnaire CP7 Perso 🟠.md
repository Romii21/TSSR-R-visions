...
**REP** :
Le SNAT consiste à faire communiquer une machines vers l'extérieur du réseau, le port de la machine est gardé et ajouté à l'adresse IP publique du réseau 
...
**REP** :
Du NAT 1:1 qui permet de faire communiquer une adresse en interne avec une adresse publique 
...
**REP** : 
Dans le principe je dirais que comme tout les communication passe par un point précis le réseau sature
